...
class WordInfoBottomSheetStyle {
  ...
  factory WordInfoBottomSheetStyle.defaults({
    ...
    return WordInfoBottomSheetStyle(
      ...
      titleText: QuranLocalizations.of(context).wordInfoTitle,
      tabRecitationsText: QuranLocalizations.of(context).tabRecitations,
      tabTasreefText: QuranLocalizations.of(context).tabMorphology,
      tabEerabText: QuranLocalizations.of(context).tabGrammar,
      unavailableDataTemplate: null,
      downloadText: QuranLocalizations.of(context).downloadLabel,
      downloadingText: QuranLocalizations.of(context).downloadingLabel,
      loadErrorText: QuranLocalizations.of(context).loadErrorText,
      noDataText: QuranLocalizations.of(context).noDataText,
      ...
      tafsirBackgroundColor: scheme.surfaceContainerLow,
      innerContainerBorderRadius: 16,
      innerShadowColor: scheme.shadow.withValues(alpha: 0.08),
      innerShadowBlurRadius: 8,
      innerShadowOffset: const Offset(0, 0),
      innerBorderColor: scheme.outlineVariant.withValues(alpha: 0.5),
      innerBorderWidth: 1.2,
      textBackgroundColor:
          isDark ? scheme.surfaceContainerLowest : scheme.surface,
      handleWidget: null,
      audioButtonColor: scheme.primary,
      audioButtonActiveColor: scheme.primary,
      audioButtonSize: 22,
      playWordTooltip: QuranLocalizations.of(context).playWordTooltip,
      playAyahWordsTooltip: QuranLocalizations.of(context).playAyahWordsTooltip,
      withTitle: true,
      withWordText: true,
      withWordAudioButton: true,
      tabLabelColor: scheme.onPrimaryContainer,
      tabUnselectedLabelColor: scheme.onSurfaceVariant,
      tabBackgroundColor: scheme.surfaceContainerLow,
      tabBarHeight: 48,
      innerContainerBoxShadow: [
        BoxShadow(
